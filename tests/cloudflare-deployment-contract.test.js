...
assert.match(workflow, /api\.cloudflare\.com\/client\/v4\/accounts\/\$CLOUDFLARE_ACCOUNT_ID\/pages\/projects\/attahirlabs-site\/deployments\?env=production/);
...
assert.match(workflow, /--project-name=attahirlabs-site/);
