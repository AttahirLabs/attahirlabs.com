...
Shopify is removing Benchmark Comparisons from Analytics. According to the [Shopify changelog](https://changelog.shopify.com/posts/benchmark-comparisons-in-analytics-will-be-removed-on-may-19th), Benchmark Comparison data will no longer show new data, and the feature will be fully removed on May 19, 2026.

That gives merchants a short window to save anything useful before it disappears.

## Quick answer

Shopify is removing Benchmark Comparisons in Analytics on May 19, 2026, according to its [official changelog notice](https://changelog.shopify.com/posts/benchmark-comparisons-in-analytics-will-be-removed-on-may-19th). Before then, save the benchmark views you actually used, replace peer comparisons with Metric Targets, and build a monthly baseline from your own conversion rate, average order value, margin, retention, and inventory sell-through.
...
Shopify says Benchmark Comparison data in Analytics will stop showing new data and the feature will be fully removed on May 19, 2026. Shopify's suggested alternatives are Metric Targets and Sidekick guidance, both mentioned in the same [official changelog notice](https://changelog.shopify.com/posts/benchmark-comparisons-in-analytics-will-be-removed-on-may-19th).

The practical meaning is simple:

- You should assume peer comparison views are temporary.
- You should save the benchmark screenshots or exports you still care about.
- You should move your decision-making toward merchant-owned targets.
- You should stop building weekly reporting habits around a feature that is going away.
...
- Conversion rate benchmark views.
- Average order value comparisons.
- Sessions or traffic comparisons.
- Returning customer or customer-retention comparisons.
- Sales trend comparisons, if you used them in monthly reviews.
- Any benchmark card that changed a real decision.
...
- Last 30 days.
- Previous 30 days.
- Same period last year, if you have it.
- Best recent period that was not caused by a one-off sale.
- Worst recent period that was not caused by a tracking break or stockout.
...
Do not replace Benchmark Comparisons with a random spreadsheet full of industry averages from old blog posts. Shopify specifically points merchants toward its own Metric Targets and Sidekick alternatives in the [official removal notice](https://changelog.shopify.com/posts/benchmark-comparisons-in-analytics-will-be-removed-on-may-19th), not toward generic public averages.
...
Shopify says in its [official changelog notice](https://changelog.shopify.com/posts/benchmark-comparisons-in-analytics-will-be-removed-on-may-19th) that the feature will be fully removed on May 19, 2026, and that Benchmark Comparison data will no longer show new data before then.
...
Not honestly, unless it has enough permissioned aggregate merchant data to build a comparable peer set. Shopify’s [own notice](https://changelog.shopify.com/posts/benchmark-comparisons-in-analytics-will-be-removed-on-may-19th) points merchants toward targets and guidance, which is a better replacement for most stores than pretending a small app can recreate Shopify-scale peer data.
...
- Shopify Changelog: [Benchmark Comparisons in Analytics will be removed on May 19th](https://changelog.shopify.com/posts/benchmark-comparisons-in-analytics-will-be-removed-on-may-19th)
