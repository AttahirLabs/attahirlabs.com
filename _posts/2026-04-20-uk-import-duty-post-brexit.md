...
> Sources: [GOV.UK Tariffs on goods imported into the UK](https://www.gov.uk/guidance/tariffs-on-goods-imported-into-the-uk), [GOV.UK Trade Tariff tool](https://www.gov.uk/trade-tariff).
...
> Sources: [CBP Determining Duty Rates](https://www.cbp.gov/trade/programs-administration/determining-duty-rates), [USITC About the HTS](https://www.cbp.gov/trade/rulings/informed-compliance-publications/marking-country-origin-us-imports).
...
2. determine origin correctly,
3. identify any applicable preference or relief,
4. make a compliant declaration,
5. calculate duty and import VAT on the correct basis.

That is true in the UK, and it is also true in other major customs systems.

CBP's guidance for U.S. importers makes the same basic point from the American side. Duty rates are determined through the Harmonized Tariff System, and the answer depends on what the product is, how it is classified, where it originates, and whether any special treatment applies. CBP also stresses that the final determination belongs to customs authorities, not to the importer merely because the importer guessed a rate.

USITC explains the same framework at the schedule level. The Harmonized Tariff Schedule is hierarchical, classification must follow legal interpretation rules, and the "general" rate column reflects normal trade relations duty rates while preferential programs may alter the result. That is a useful reminder for UK traders too: customs outcomes depend on legal classification and legal eligibility, not marketing descriptions or invoice shortcuts.

## Brexit did not create blanket tariffs between the UK and EU

> Sources: [European Commission, EU-UK Trade and Cooperation Agreement](https://commission.europa.eu/strategy-and-policy/relations-united-kingdom/eu-uk-trade-and-cooperation-agreement_en), [GOV.UK preference agreements and rules of origin guidance](https://www.gov.uk/guidance/import-and-export-goods-using-preference-agreements).
...
> Sources: [GOV.UK preference agreements and rules of origin guidance](https://www.gov.uk/guidance/import-and-export-goods-using-preference-agreements).
...
> Sources: [GOV.UK UK goods and services schedules at the WTO](https://goods-schedules.wto.org/member/united-kingdom), [WTO goods schedules, United Kingdom](https://goods-schedules.wto.org/member/united-kingdom).
...
> Sources: [GOV.UK Tariffs on goods imported into the UK](https://www.gov.uk/guidance/tariffs-on-goods-imported-into-the-uk), [HMRC import VAT guidance](https://www.gov.uk/guidance/vat-imports-acquisitions-and-purchases-from-abroad).
...
The U.S. Department of Commerce's UK Brexit FAQ also highlights a practical post-Brexit VAT distinction for low-value consignments. For consignments valued at £135 or less sold directly to UK consumers, UK supply VAT can be due at the point of sale rather than import VAT being handled in the old way. That does not replace the broader customs framework, but it is a good reminder that post-Brexit compliance is not only about headline tariff rates.

## Northern Ireland remains a special case

> Sources: [GOV.UK Tariffs on goods imported into the UK](https://www.gov.uk/guidance/tariffs-on-goods-imported-into-the-uk), [GOV.UK Northern Ireland at-risk guidance](https://www.gov.uk/guidance/check-if-you-can-declare-goods-you-bring-into-northern-ireland-not-at-risk-of-moving-to-the-eu).
...
> Sources: [CBSA Customs Notice 21-07](https://www.cbsa-asfc.gc.ca/publications/cn-ad/cn21-07-eng.html).
...
> Sources: [CBP Determining Duty Rates](https://www.cbp.gov/trade/programs-administration/determining-duty-rates).
...
CBP's duty-rate guidance is instructive here because it emphasizes that even small factual differences can change the rate. Composition, assembly location, qualification for preference, and product details all matter. Post-Brexit UK trade now demands the same discipline. A generic spreadsheet with country-level assumptions is not enough if you are importing serious volume.

## The cost of getting it wrong is not just the duty itself

> Sources: [Tax Foundation tariff research](https://taxfoundation.org/research/all/federal/trump-tariffs-trade-war/).
...
Tax Foundation's trade work is useful here not because it gives a UK import matrix, but because it reminds businesses that tariffs are still taxes on cross-border goods and that tariff changes meaningfully affect cost structure, economic behavior, and compliance burdens. The broad lesson holds: even when the rate sounds modest, tariff friction can materially change commercial outcomes.
...
> Sources: [GOV.UK Trade Tariff tool](https://www.gov.uk/trade-tariff), [Finding commodity codes for imports into or exports out of the UK](https://www.gov.uk/guidance/finding-commodity-codes-for-imports-or-exports).
...
> Source: [GOV.UK preference agreements and rules of origin guidance](https://www.gov.uk/guidance/import-and-export-goods-using-preference-agreements).
...
> Sources: [GOV.UK preference agreements and rules of origin guidance](https://www.gov.uk/guidance/import-and-export-goods-using-preference-agreements), [European Commission TCA overview](https://commission.europa.eu/strategy-and-policy/relations-united-kingdom/eu-uk-trade-and-cooperation-agreement_en).
...
> Source: [HMRC import VAT guidance](https://www.gov.uk/guidance/vat-imports-acquisitions-and-purchases-from-abroad).
...
> Source: [GOV.UK Tariffs on goods imported into the UK](https://www.gov.uk/guidance/tariffs-on-goods-imported-into-the-uk).
...
> Sources: [GOV.UK Tariffs on goods imported into the UK](https://www.gov.uk/guidance/tariffs-on-goods-imported-into-the-uk), [Tax Foundation tariff research](https://taxfoundation.org/research/all/federal/trump-tariffs-trade-war/).
...
> Sources: [GOV.UK preference agreements and rules of origin guidance](https://www.gov.uk/guidance/import-and-export-goods-using-preference-agreements), [GOV.UK Tariffs on goods imported into the UK](https://www.gov.uk/guidance/tariffs-on-goods-imported-into-the-uk).
...
> Sources: [GOV.UK Tariffs on goods imported into the UK](https://www.gov.uk/guidance/tariffs-on-goods-imported-into-the-uk), [GOV.UK preference agreements and rules of origin guidance](https://www.gov.uk/guidance/import-and-export-goods-using-preference-agreements), [CBSA Customs Notice 21-07](https://www.cbsa-asfc.gc.ca/publications/cn-ad/cn21-07-eng.html).


### 1. Did Brexit mean the UK started charging tariffs on all EU imports?

> Sources: [European Commission TCA overview](https://commission.europa.eu/strategy-and-policy/relations-united-kingdom/eu-uk-trade-and-cooperation-agreement_en), [GOV.UK preference agreements and rules of origin guidance](https://www.gov.uk/guidance/import-and-export-goods-using-preference-agreements).
...
> Source: [GOV.UK Northern Ireland at-risk guidance](https://www.gov.uk/guidance/check-if-you-can-declare-goods-you-bring-into-northern-ireland-not-at-risk-of-moving-to-the-eu).
...
> Source: [CBSA Customs Notice 21-07](https://www.cbsa-asfc.gc.ca/publications/cn-ad/cn21-07-eng.html).
...
> Sources: [GOV.UK Tariffs on goods imported into the UK](https://www.gov.uk/guidance/tariffs-on-goods-imported-into-the-uk), [GOV.UK preference agreements and rules of origin guidance](https://www.gov.uk/guidance/import-and-export-goods-using-preference-agreements), [WTO goods schedules, United Kingdom](https://goods-schedules.wto.org/member/united-kingdom).
...
1. [European Commission, *The EU-UK Trade and Cooperation Agreement*](https://commission.europa.eu/strategy-and-policy/relations-united-kingdom/eu-uk-trade-and-cooperation-agreement_en)
2. [WTO Goods Schedules eLibrary, *United Kingdom*](https://goods-schedules.wto.org/member/united-kingdom)
3. [U.S. Customs and Border Protection, *Determining Duty Rates*](https://www.cbp.gov/trade/programs-administration/determining-duty-rates)
4. [U.S. Customs and Border Protection, *Marking of Country of Origin on U.S. Imports*](https://www.cbp.gov/trade/rulings/informed-compliance-publications/marking-country-origin-us-imports)
5. [Canada Border Services Agency, *Customs Notice 21-07 - Implementation of the Canada-United Kingdom Trade Continuity Agreement*](https://www.cbsa-asfc.gc.ca/publications/cn-ad/cn21-07-eng.html)
